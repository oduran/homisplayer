...
var doubleClickFunctions = function()
{
  ...
  $(".editablemultipleimages").on('dblclick' ,function () {
    ...
    $("#right .right-image").each(function(e,el)
    {
     ...
     {  
       debugger;
       images[e] = "<video class='right-image' src='"+el.src+"' type='video/webm' style='width:250px;margin-left:20px;float:left'></video>";
     }
     else
     {
      images[e] = "<img  class='right-image' src='"+el.src+"' style='width:250px;margin-left:20px;float:left' />"; 
     }
