...
if ! [ "$(ping -c 1 google.com)" ]; then
	...
	sudo killall wpa_supplicant >> /home/homis/log/${filenameuniqueid}_${filenamedate};
	sudo service network-manager restart >> /home/homis/log/${filenameuniqueid}_${filenamedate};
else
